...
GrandesNumeros Fatorial(int Num , GrandesNumeros Numero)
{
    ...
    mpf_init2(Auxiliar.m_Resultado, 65536);
...
GrandesNumeros Thread_Soma(int Iteracoes)
{
    ...
    mpf_init2(Numero2.m_Resultado, 65536);
    mpf_set_str(Numero2.m_Resultado, "0", 10);
    
    mpf_init2(Soma.m_Resultado, 65536);
    mpf_set_str(Soma.m_Resultado, "0", 10);
    
    mpf_init2(Numero3.m_Resultado, 65536);
...
int main(int  argc, char *argv[])
{
	...
	mpf_init2(Euler.m_Resultado, 65536);
